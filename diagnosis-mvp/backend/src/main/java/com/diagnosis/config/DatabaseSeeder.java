...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            ...
            System.err.println("WARN: Database seeding failed (Supabase may be paused or unreachable). Application will start with mock fallbacks.");
        }
    }
    ...
    private void seedUser(UUID id, String email, String plainPassword, Role role, String name, String crm, Municipio municipio) {
        try {
            ...
            System.err.println("WARN: Could not seed user " + email);
        }
    }
}
